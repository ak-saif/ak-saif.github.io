  ...
  navbar:
    ...
    right:
      ...
      - icon: github
        ...
        aria-label: GitHub
  page-footer:
    center: "© Dr. S. A. Khan · built with Quarto"
    border: false
...
about:
  ...
  links:
    ...
    - icon: mortarboard-fill
      text: Google Scholar
      href: "#"                              # add your Scholar profile URL
...
echo "All files created. Now copy photo.jpg and CV_with_publication.docx into this folder if not already there."
